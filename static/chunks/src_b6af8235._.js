...
const SpendSmartDashboard = ()=>{
    ...
    const currentPayrollPeriod = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "SpendSmartDashboard.useMemo[currentPayrollPeriod]": ()=>{
            ...
            const sortedIncomes = [
                ...
                "SpendSmartDashboard.useMemo[currentPayrollPeriod].sortedIncomes": (a, b)=>a.payroll - b.payroll
            }["SpendSmartDashboard.useMemo[currentPayrollPeriod].sortedIncomes"]);
            const currentPayrollIncome = sortedIncomes.find({
            ...
            const nextPayrollIncome = sortedIncomes.find({
                "SpendSmartDashboard.useMemo[currentPayrollPeriod].nextPayrollIncome": (i)=>i.payroll === selectedPayroll + 1
            }["SpendSmartDashboard.useMemo[currentPayrollPeriod].nextPayrollIncome"]);
            if (!currentPayrollIncome) return null;
            const startDate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$parseISO$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseISO"])(currentPayrollIncome.date);
            const endDate = nextPayrollIncome ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$parseISO$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseISO"])(nextPayrollIncome.date) : new Date(startDate.getFullYear(), startDate.getMonth() + 1, startDate.getDate());
            return {
                startDate,
                endDate,
    ...
    const dailyBudget = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "SpendSmartDashboard.useMemo[dailyBudget]": ()=>{
            ...
            const totalSpentInPeriod = expenses.filter({
                "SpendSmartDashboard.useMemo[dailyBudget].totalSpentInPeriod": (exp)=>{
            ...
            }["SpendSmartDashboard.useMemo[dailyBudget].totalSpentInPeriod"]).reduce({
                "SpendSmartDashboard.useMemo[dailyBudget].totalSpentInPeriod": (acc, exp)=>acc + exp.amount
            }["SpendSmartDashboard.useMemo[dailyBudget].totalSpentInPeriod"], 0);
...
_s(SpendSmartDashboard, "JDi2fo/Fj2O+csSuSCcT1jX3s8Q=", false, function() {
    return [
...
//# sourceMappingURL=src_b6af8235._.js.map